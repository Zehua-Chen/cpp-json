...
typename Parser<CharT>::_Context Parser<CharT>::_context()
{
    ...
    {
    case BasicValue<CharT>::Type::object:
        return _Context::object;
    case BasicValue<CharT>::Type::array:
...
void Parser<CharT>::_start(const token::Token<CharT> &token)
{
    ...
    case _TType::beginObject:
        _stack.emplace_back("", _VType::object);
        _state = _State::objectStart;
        return;
    case _TType::beginArray:
        _stack.emplace_back("", _VType::array);
